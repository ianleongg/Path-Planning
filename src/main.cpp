...
int main() {
 ...
 // Initilize car's lane and reference velocity
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Determine the possible actions
            ...
            // If theres a car in front, prepare to switch lane
            if ( car_ahead ) { 
              // if there is no car left and there is a left lane. Change to left lane.
              if ( !car_left && lane > 0 ) {
                lane--; 
                
              } else if ( !car_righ && lane != 2 ){
                // if there is no car right and there is a right lane. Change to right lane.
                lane++; 
              ...
              // if we're not on the moddle lane, we want to switch back to the middle lane
              if ( lane != 1 ) { 
